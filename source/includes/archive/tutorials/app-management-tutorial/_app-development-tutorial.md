...
curl -sk -H "Authorization: Bearer api-access-token" https://api.example.com/files/v2/listings/data.agaveplatform.org/$API_USERNAME/applications

# If you see: File/folder does not exist
# then you need to create an applications directory
curl -sk -H "Authorization: Bearer de32225c235cf47b9965997270a1496c" -X POST -d "action=mkdir&amp;path=applications" https://api.example.com/files/v2/listings/data.agaveplatform.org/$API_USERNAME
```
...
```shell
# Check to see if you have an applications directory
files-list -S data.agaveplatform.org $IPLANTUSERNAME/applications
# If you see: File/folder does not exist
# then you need to create an applications directory
files-mkdir -S data.agaveplatform.org -N "applications" $IPLANTUSERNAME/
```
...
files-upload -S data.agaveplatform.org -F samtools-0.1.19 $IPLANTUSERNAME/applications
```
